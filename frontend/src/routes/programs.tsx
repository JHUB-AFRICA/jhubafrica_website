  ...
  head: () => ({
    meta: [
      { title: "Programs & Events — JHUB Africa" },
      {
        name: "description",
        content:
          "Innovation programs, upcoming events, past events, calendar and event proposals at JHUB Africa.",
      },
      { property: "og:title", content: "Programs & Events — JHUB Africa" },
      {
        property: "og:description",
        content: "Programs, events and calendar for the JHUB community.",
      },
    ],
  }),
...
const PROGRAMS = [
  {
    t: "Startup Incubator",
    d: "12-week structured incubation for early-stage founders.",
    color: "green" as const,
  },
  {
    t: "Applied Research",
    d: "Collaborative R&D with JKUAT faculties and industry sponsors.",
    color: "" as const,
  },
  {
    t: "Innovation Challenges",
    d: "Themed sprints backed by partners in agri, health and finance.",
    color: "red" as const,
  },
];
...
const UPCOMING = [
  {
    ...
    desc: "Cohort showcase of student-led startups pitching to investors and partners.",
  },
  {
    day: "24",
    month: "Jul",
    title: "AI for Africa Hackathon",
    desc: "48-hour hackathon focused on applied AI solutions for local industries.",
  },
  {
    day: "09",
    month: "Aug",
    title: "Founders Fireside",
    desc: "Conversations with African founders on building and scaling ventures.",
  },
];
