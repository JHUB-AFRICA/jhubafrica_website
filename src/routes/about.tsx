    ...
    <>
      ...
      <section className="feature-split">
        <div className="split-copy">
          <h2>Our story</h2>
          <p>Founded in {FOUNDED_YEAR}, JHUB Africa was established to bridge the gap between academic research and industry, giving students, researchers and entrepreneurs the structure, mentorship and networks needed to build real ventures.</p>
