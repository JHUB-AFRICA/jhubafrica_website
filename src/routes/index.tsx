    ...
    return (
        <>
            ...
            <div className="stats-bar">
                <div className="stat"><div className="stat-n">400+</div><div className="stat-l">Innovators Supported</div></div>
                <div className="stat"><div className="stat-n">150+</div><div className="stat-l">Innovations in Portfolio</div></div>
                <div className="stat"><div className="stat-n">40+</div><div className="stat-l">Industry & Research Partners</div></div>
                <div className="stat"><div className="stat-n">15+</div><div className="stat-l">Active Programs</div></div>
            </div>

            <section className="content-section">
                <div className="section-eyebrow">Choose your path</div>
                <h2 className="section-h2">Where do you fit in the ecosystem?</h2>
                <p className="section-p">JHUB Africa serves innovators, students, funders, partners, researchers and the wider community. Pick your role and we'll point you to the right next step.</p>
                <div className="cards-grid">
                    <Link to="/innovation" className="prog-card audience-card">
                        ...
                        <p className="prog-desc">Get mentorship, prototyping support, funding pathways and market access for your venture.</p>
                        <div className="prog-meta"><span className="prog-slots">Open intake</span><span className="prog-arrow">Submit innovation →</span></div>
                    </Link>
                    <Link to="/courses" className="prog-card audience-card">
                        ...
                        <p className="prog-desc">Join courses, the innovation club, hackathons, workshops and volunteer opportunities.</p>
                        <div className="prog-meta"><span className="prog-slots">Quarterly cohorts</span><span className="prog-arrow">Explore courses →</span></div>
                    </Link>
                    <Link to="/support" className="prog-card audience-card">
                        ...
                        <p className="prog-desc">Discover credible, fundable innovations across agritech, climate, AI and digital trade.</p>
                        <div className="prog-meta"><span className="prog-slots">Sponsor packages</span><span className="prog-arrow">View portfolio →</span></div>
                    </Link>
                    <Link to="/contact" className="prog-card audience-card">
                        <span className="prog-tag prog-tag-b">Partner</span>
                        <div className="prog-title">My organisation wants to collaborate</div>
                        <p className="prog-desc">Co-design programs, challenge calls, pilots and applied research across sectors.</p>
                        <div className="prog-meta"><span className="prog-slots">Tailored programs</span><span className="prog-arrow">Partner with JHUB →</span></div>
                    </Link>
                    <Link to="/innovation" className="prog-card audience-card">
                        <span className="prog-tag prog-tag-g">Researcher</span>
                        <div className="prog-title green">I want to commercialise research</div>
                        <p className="prog-desc">Access labs, IP support, mentorship and pathways to translate research into ventures.</p>
                        <div className="prog-meta"><span className="prog-slots">Rolling</span><span className="prog-arrow">Collaborate →</span></div>
                    </Link>
                    <Link to="/news" className="prog-card audience-card">
                        ...
                        <p className="prog-desc">Read news, impact stories and announcements from across the JHUB Africa community.</p>
                        <div className="prog-meta"><span className="prog-slots">Updated weekly</span><span className="prog-arrow">Read stories →</span></div>
                    </Link>
                </div>
            </section>
